...
def teacher_screen_login():
    ...
    with btnc1:
        if st.button('Login', icon=':material/passkey:',use_container_width=True,shortcut='control+enter'):
    ...
    with btnc2:
        if st.button('Register Instead', icon=':material/passkey:',type='primary', use_container_width=True):
